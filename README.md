...
# Feature
<code>Own custom multiboot bootloader capable of booting from numerous hardware devices
...
. Support for computer clusters, grid computing and network nodes</code>
